        ...
        <div class="panel sm:w-[480px] m-6 max-w-lg w-full">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="name" type="text" class="form-input" name="name" required autofocus autocomplete="name"  />
                </div>
                <div>
                    <label for="email">Email</label>
                    <input id="email" type="email" class="form-input" name="email" required autocomplete="username" />
                </div>
                <div>
                ...
                <div>
                    <label for="terms" class="cursor-pointer">
                        ...
                        <span for="custom_checkbox" class="text-white-dark" name="terms" id="terms" required>
                ...
                <button class="btn btn-primary w-full">   {{ __('Register') }}</button>
            </form>
            <div
            ...
            <p class="text-center">{{ __('Already registered?') }} <a href="{{ route('login') }}"
